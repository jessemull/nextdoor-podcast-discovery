...
db-bootstrap:
	...
	@(echo "-- Generated by 'make db-bootstrap'. Source: database/migrations/ 001-036 in order. Do not edit by hand."; echo ""; for f in $$(ls database/migrations/*.sql | sort -V); do cat "$$f"; done) > database/bootstrap.sql
...
db-migrate-local:
	@echo "Running migrations on local database (001 through 036)..."
...
db-migrate-prod:
	...
	@echo "   001_initial_schema.sql through 036_backfill_dimension.sql"
