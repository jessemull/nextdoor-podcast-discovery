...
- [ ] **Clean up permalink logs**: Tidy up logs for `fetch_permalink` jobs (less noise, clearer success/error summaries) and ensure permalink processing uses the same colored, structured logging as the main scraper/worker.
