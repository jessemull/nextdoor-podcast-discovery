...
export default async function PodcastHomePage({
  ...
  return (
    <div
      className={`mx-auto mt-2 min-w-0 w-full max-w-6xl px-5 pb-8 pt-3 sm:px-7 ${
      ...
      >
        <div
          className={
            hasDesktopSearch
              ? "contents"
              : "grid w-full min-w-0 max-w-full grid-cols-1 gap-8 md:max-lg:grid-cols-[minmax(0,20.5rem)_minmax(0,1fr)] md:max-lg:items-start md:max-lg:gap-x-10 md:max-lg:gap-y-8 lg:flex lg:w-fit lg:max-w-full lg:flex-row lg:items-stretch lg:gap-10"
          }
        >
          {/* Left column: logo — rectangle, no clipping, height spans hero */}
          <aside
            aria-hidden
            className="mx-auto flex w-full max-w-[20.5rem] shrink-0 flex-col items-stretch md:mx-0 md:w-[20.5rem] md:max-w-none md:max-lg:col-start-1 md:max-lg:row-start-1 md:max-lg:self-start md:items-start md:justify-end lg:h-full lg:min-h-[420px] lg:w-[20.5rem] lg:items-start lg:justify-end"
          >
            <div className="relative aspect-[792/1224] w-full shrink-0 overflow-hidden rounded-3xl border border-podcast-accent md:w-[20.5rem] lg:w-[20.5rem]">
              <Image
                alt={PODCAST_NAME}
          ...
          <section
            ...
            className="mb-4 flex min-w-0 w-full max-w-full flex-col gap-4 md:mb-0 md:max-lg:col-start-2 md:max-lg:row-start-1 md:max-lg:self-start lg:mb-0 lg:flex lg:h-full lg:w-[34rem] lg:flex-col lg:gap-6 lg:shrink-0"
          >
            <h1
              className={`text-podcast-foreground mb-4 hidden max-w-full break-words text-5xl font-bold tracking-tight sm:text-6xl lg:block ${playfair.className}`}
            >
              {PODCAST_NAME}
            </h1>
            <p className="text-xl text-[#9fb7c4]">
            ...
            <p className="mb-4 text-lg leading-relaxed text-[#9fb7c4]">
              {DESCRIPTION}
            </p>
            <Link
          ...
          <div className="w-full md:max-lg:col-span-2 md:max-lg:row-start-2 lg:hidden">
            <HeroContactRow />
          </div>
        </div>
      </div>
